...
namespace BookstoreAPI.Controllers
{
    ...
    public class BooksController : ControllerBase
    {
        ...
        /// The BookID is auto-generated by SQLite, so it should be 0 or omitted.
        /// Returns the created book with its new ID and a 201 Created status.
        /// </summary>
        [HttpPost]
        ...
        /// The id in the URL must match the BookID in the request body.
        /// Returns 204 No Content on success, 400 if IDs don't match,
        /// or 404 if the book doesn't exist.
        /// </summary>
        [HttpPut("{id}")]
        ...
        /// <summary>
        /// DELETE /api/books/{id}
        /// Removes a book from the database by its BookID.
        /// Returns 204 No Content on success, or 404 if the book doesn't exist.
        /// </summary>
        [HttpDelete("{id}")]
